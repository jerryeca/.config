  ...
  if (import_vscode_languageserver_protocol2.TextDocumentEdit.is(change)) {
    ...
    for (const indel of change.edits) {
      ...
      if (parsed) {
        ...
        if (snipLength) {
          selection = import_coc5.Range.create(startLine, startCol, startLine, startCol + snipLength);
        } else {
          position = import_coc5.Position.create(startLine, startCol);
        }
        newText = insert;
      } else {
...
function openDocs2(ctx) {
  return async () => {
    ...
    if (doclink == null ? void 0 : doclink.web) {
